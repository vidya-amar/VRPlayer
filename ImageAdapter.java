    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (mImageArray){
            ...
            case 4:
                ...
                break;
            case 5:
                imageView.setImageResource(mThumbIds5[position]);
                break;
            case 6:
                imageView.setImageResource(mThumbIds6[position]);
                break;
            case 7:
                imageView.setImageResource(mThumbIds7[position]);
                break;
            case 8:
                imageView.setImageResource(mThumbIds8[position]);
                break;
            case 9:
                imageView.setImageResource(mThumbIds9[position]);
                break;
            case 10:
                imageView.setImageResource(mThumbIds10[position]);
                break;
            case 11:
                imageView.setImageResource(mThumbIds11[position]);
                break;
            case 12:
                imageView.setImageResource(mThumbIds12[position]);
                break;
            case 13:
                imageView.setImageResource(mThumbIds13[position]);
                break;
            case 14:
                imageView.setImageResource(mThumbIds14[position]);
                break;
            case 15:
                imageView.setImageResource(mThumbIds15[position]);
                break;
            case 16:
                imageView.setImageResource(mThumbIds16[position]);
                break;
            case 17:
                imageView.setImageResource(mThumbIds17[position]);
                break;
            case 18:
                imageView.setImageResource(mThumbIds18[position]);
                break;
            default:
                imageView.setImageResource(mThumbIds0[position]);
                break;
